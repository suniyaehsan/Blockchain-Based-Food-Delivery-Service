  ...
  init: async function () {
    ...
    $.getJSON('../food.json', function (data) {
      ...
      for (i = 0; i < data.length; i++) {
        ...
        foodTemplate.find('.food-name').text(data[i].name);
        foodTemplate.find('.food-price').text(data[i].price);
        foodTemplate.find('.btn-adopt').attr('data-id', data[i].id);
